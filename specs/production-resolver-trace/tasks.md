# Production Resolver Trace tasks

- [x] Select and pin one resolver and upstream commit.
- [x] Record requirements, design, and threat model.
- [x] Implement Knot internal lifecycle hook.
- [x] Implement Rust Trace Producer and durable Adapter acknowledgement.
