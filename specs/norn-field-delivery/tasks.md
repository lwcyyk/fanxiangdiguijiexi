# Go-Norn field delivery tasks

- [x] Create `norn-field-delivery` from the approved baseline.
- [x] Define three package templates and shared lifecycle logic.
- [x] Add strict non-secret Inventory validation.
- [x] Add deterministic package, manifest and checksum rendering.
- [x] Encode Norn native gRPC and read-only mTLS boundaries.
